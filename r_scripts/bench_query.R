...
legend<- "Temps de la requête et de construction du modèle microsopique"
...
plot<-plot + scale_color_discrete(name="Optimisation de la requête",
breaks=c("OPT", "NOPT", "T", "EP", "ET", "TEP", "TET", "EPET"),
labels=c("T+S+J", "Pas d'Optimisation", "T", "S", "J", "T+S", "T+J", "S+J" ))
plot<-plot+ scale_shape_manual(name="Optimisation de la requête",
